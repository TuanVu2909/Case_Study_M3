...
<div class="container">
    ...
    <form style="width: 600px; margin: auto" action="/Home_StayServlet?action=create" method="post">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="home_name" id="home_name" placeholder="Enter home_stay">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="depict" id="depict" placeholder="Enter depict">
        </div>
        <div class="mb-3">
