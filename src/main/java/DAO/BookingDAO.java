...
public class BookingDAO {
    ...
    private final String INSERT_INTO = "insert into booking(user_id,home_id,status_id,start_date, end_date, action) value (?,?,?,?,?,?);";
    ...
    public List<Booking> getBookingList() {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ALL)) {
            ...
            while (resultSet.next()) {
                ...
                Booking booking = new Booking(id, user, homeStay, status, start_date, end_date, action);
    ...
    public void CreateBooking(Booking booking) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(INSERT_INTO)) {
            ...
            preparedStatement.setInt(3, booking.getStatus().getId());
            preparedStatement.setDate(4, booking.getStart_date());
            preparedStatement.setDate(4, booking.getEnd_date());
